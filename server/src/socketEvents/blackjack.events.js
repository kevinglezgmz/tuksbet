...
function initBlackjackGameRound(userId, clientSocket) {
  ...
  axios.post(process.env.SERVER_URL + 'api/gameRounds', { gameId: blackjackId }).then((response) => {
...
function blackjackHit(userId, clientSocket, isDouble) {
  if (userId === undefined) {
    return;
  }
...
function blackjackDouble(userId, clientSocket) {
  ...
  blackjackHit(userId, clientSocket, true);
...
function blackjackCloseGameround(gameData, clientSocket) {
  ...
  closeGameround(gameData.gameroundId, gameData.userId, currGame, clientSocket);
}

function closeGameround(gameroundId, userId, currGame, clientSocket) {
  axios
